    ...
    <div className={`p-4 sm:p-6 min-h-[80vh]`}>
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4 sm:gap-0">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium transition-all duration-200 shadow-lg hover:shadow-xl w-full sm:w-auto"
        >
          <FaPlus /> New Course
        </button>
      </div>
      {loading ? (
        <div className="flex items-center justify-center min-h-[200px] sm:min-h-[300px]">
          <div
            className={`animate-spin h-8 w-8 sm:h-10 sm:w-10 border-3 ${
              isDark ? "border-indigo-700" : "border-indigo-500"
          ...
          {courses.map((course, i) => {
            ...
            return (
              <motion.div
                ...
                className={`rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl border p-4 sm:p-6 flex flex-col gap-3 sm:gap-4 hover:shadow-2xl transition-all duration-300 ${
                  isDark
              ...
              >
                ...
                {/* Stats Row */}
                <div
                  className={`flex flex-col sm:flex-row items-start sm:items-center justify-between py-2 sm:py-3 px-3 sm:px-4 rounded-xl border ${
                    isDark
                ...
                <div className="flex flex-wrap items-center gap-2 mt-2">
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg text-xs font-medium transition-all duration-200 border ${
                      isDark
                ...
                {/* Footer */}
                <div
                  className={`flex flex-col sm:flex-row justify-between items-start sm:items-center pt-2 sm:pt-3 border-t text-xs ${
                    isDark
